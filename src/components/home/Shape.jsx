    ...
    return (
        <div className="absolute left-0 top-0 w-full h-full z-10">
            ...
            <svg
                width="26"
                height="26"
                className="absolute left-[75%] top-[50%]"
                xmlns="http://www.w3.org/2000/svg"
            >
                <path
            ...
            <svg
                width="30"
                height="25"
                className="absolute left-[28%] top-[65%]"
                xmlns="http://www.w3.org/2000/svg"
            >
                <path
            ...
            <svg
                width="15"
                height="23"
                className="absolute left-[70%] top-[15%]"
                xmlns="http://www.w3.org/2000/svg"
            >
                <rect
                    transform="rotate(30 9.86603 10.13397)"
            ...
            <svg
                width="19"
                height="21"
                className="absolute left-[82%] top-[90%]"
                xmlns="http://www.w3.org/2000/svg"
            >
                <rect
            ...
            <svg
                width="30"
                height="25"
                className="absolute left-[32%] top-[90%]"
                xmlns="http://www.w3.org/2000/svg"
            >
                <path
            ...
            <svg
                width="47"
                height="29"
                className="absolute left-[67%] top-[67%]"
                xmlns="http://www.w3.org/2000/svg"
            >
            ...
            <svg
                width="33"
                height="20"
                className="absolute left-[87%] top-[27%]"
                xmlns="http://www.w3.org/2000/svg"
            >
                <path
